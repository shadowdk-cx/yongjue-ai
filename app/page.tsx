...
import { Settings, FileText, Image, Video } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <main className="flex-1 overflow-hidden flex flex-col">
        <div className={activeTab === 'text' ? 'flex-1 overflow-hidden flex flex-col' : 'hidden'}>
          <TextWorkflow apiKey={apiKey} provider={provider} textModel={textModel} />
        </div>
        <div className={activeTab === 'image' ? 'flex-1 overflow-hidden flex flex-col' : 'hidden'}>
          <ImageWorkflow apiKey={apiKey} provider={provider} textModel={textModel} imageModel={imageModel} />
        </div>
        <div className={activeTab === 'video' ? 'flex-1 overflow-hidden flex flex-col' : 'hidden'}>
